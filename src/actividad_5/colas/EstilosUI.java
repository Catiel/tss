...
/** Reutiliza estilos ya definidos en ejercicios previos. */
public class EstilosUI { // Clase utilitaria que proporciona métodos estáticos para aplicar estilos consistentes a componentes UI en simulaciones de colas
