...
public class ejercicio3Random extends JFrame {
    ...
    public ejercicio3Random() {
        setTitle("Simulación Barras Defectuosas - Versión Aleatoria");
        setSize(1100, 450);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new ejercicio3Random().setVisible(true);
        });
    }
}
