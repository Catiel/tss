package actividad_9.ejercicio_1; // Define el paquete donde se encuentra esta clase
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        InventorySystemSimulatorAleatorio simAleatorio = new InventorySystemSimulatorAleatorio(); // Instancia la simulación aleatoria
        InventorySystemSimulatorEditable simManual = new InventorySystemSimulatorEditable(); // Instancia la simulación manual
        InventorySystemSimulator simPredeterminado = new InventorySystemSimulator(); // Instancia la simulación predeterminada
