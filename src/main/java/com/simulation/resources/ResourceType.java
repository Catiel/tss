...
public record ResourceType(String name, int units,
                           double speedMetersPerMinute) { // Record que define el tipo de recurso con nombre, cantidad de unidades y velocidad en metros por minuto
