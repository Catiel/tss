...
public class TableFormatter {
    ...
    public static String formatEntityTable(java.util.Map<String, com.simulation.entities.EntityStatistics> stats) {
        ...
        for (com.simulation.entities.EntityStatistics stat : stats.values()) {
            sb.append(String.format("%-25s %15d %25d %35s %40s %30s %30s %30s\n",
                stat.getEntityName(),
                stat.getTotalExits(),
                stat.getCurrentInSystem(), // ACTUALIZADO para mostrar cantidad actual
    ...
    public static String formatLocationTable(java.util.Map<String, com.simulation.locations.LocationStatistics> stats) {
        StringBuilder sb = new StringBuilder();
        ...
        for (com.simulation.locations.LocationStatistics stat : stats.values()) {
