package actividad_8.OPTQuest1; // Define el paquete donde se encuentra esta clase

import actividad_8.ejercicio_5.SimuladorInventarioAleatorio;
import actividad_8.ejercicio_5.SimuladorInventarioEditable;
import actividad_8.ejercicio_5.SimuladorInventarioReadOnly;
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        OptimizadorPreciosHotelAleatorio simAleatorio = new OptimizadorPreciosHotelAleatorio(); // Instancia la simulación aleatoria
        OptimizadorPreciosHotelEditable simManual = new OptimizadorPreciosHotelEditable(); // Instancia la simulación manual
        OptimizadorPreciosHotel simPredeterminado = new OptimizadorPreciosHotel(); // Instancia la simulación predeterminada
