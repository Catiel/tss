package actividad_8; // Define el paquete donde se encuentra esta clase
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        actividad_8.OPTQuest1.SimulacionCompletaTabbedApp OptQuest1 = new actividad_8.OPTQuest1.SimulacionCompletaTabbedApp();
        actividad_8.OPTQuest2.SimulacionCompletaTabbedApp OptQuest2 = new actividad_8.OPTQuest2.SimulacionCompletaTabbedApp();
        actividad_8.ejercicio_4.SimulacionCompletaTabbedApp ejercicio_4 = new actividad_8.ejercicio_4.SimulacionCompletaTabbedApp();
        actividad_8.ejercicio_5.SimulacionCompletaTabbedApp ejercicio_5 = new actividad_8.ejercicio_5.SimulacionCompletaTabbedApp();

        tabs.addTab("ejercicio 4", wrapInPanel(ejercicio_4)); // Agrega la pestaña de simulación predeterminada
        tabs.addTab("ejercicio 5", wrapInPanel(ejercicio_5)); // Agrega la pestaña de simulación predeterminada
        tabs.addTab("OptQuest1", wrapInPanel(OptQuest1)); // Agrega la pestaña de simulación predeterminada
        tabs.addTab("OptQuest2", wrapInPanel(OptQuest2)); // Agrega la pestaña de simulación predeterminada
