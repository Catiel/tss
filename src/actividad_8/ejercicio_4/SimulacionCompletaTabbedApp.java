package actividad_8.ejercicio_4; // Define el paquete donde se encuentra esta clase
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        SimuladorAleatorio simAleatorio = new SimuladorAleatorio(); // Instancia la simulación aleatoria
        SimuladorManual simManual = new SimuladorManual(); // Instancia la simulación manual
        SimuladorProyecto simPredeterminado = new SimuladorProyecto(); // Instancia la simulación predeterminada
