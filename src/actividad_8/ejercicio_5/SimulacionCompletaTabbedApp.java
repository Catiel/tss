package actividad_8.ejercicio_5; // Define el paquete donde se encuentra esta clase

import actividad_8.ejercicio_4.SimuladorAleatorio;
import actividad_8.ejercicio_4.SimuladorManual;
import actividad_8.ejercicio_4.SimuladorProyecto;
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        SimuladorInventarioAleatorio simAleatorio = new SimuladorInventarioAleatorio(); // Instancia la simulación aleatoria
        SimuladorInventarioEditable simManual = new SimuladorInventarioEditable(); // Instancia la simulación manual
        SimuladorInventarioReadOnly simPredeterminado = new SimuladorInventarioReadOnly(); // Instancia la simulación predeterminada
