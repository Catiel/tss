package actividad_8.OPTQuest2; // Define el paquete donde se encuentra esta clase

import actividad_8.OPTQuest1.OptimizadorPreciosHotel;
import actividad_8.OPTQuest1.OptimizadorPreciosHotelAleatorio;
import actividad_8.OPTQuest1.OptimizadorPreciosHotelEditable;
...
public class SimulacionCompletaTabbedApp extends JFrame { // Clase principal que extiende JFrame
    public SimulacionCompletaTabbedApp() { // Constructor de la ventana principal
        ...
        OptimizadorSeleccionProyectosAleatorio simAleatorio = new OptimizadorSeleccionProyectosAleatorio(); // Instancia la simulación aleatoria
        OptimizadorSeleccionProyectosManual simManual = new OptimizadorSeleccionProyectosManual(); // Instancia la simulación manual
        OptimizadorSeleccionProyectos simPredeterminado = new OptimizadorSeleccionProyectos(); // Instancia la simulación predeterminada
