...
public class OptimizadorSeleccionProyectosAleatorio extends JFrame {
    ...
    public OptimizadorSeleccionProyectosAleatorio() {
        super("Selección de proyectos con generación aleatoria");
        configurarUI();
        setSize(1500, 750);
    ...
    private JPanel crearTitulo() {
        ...
        panel.setBackground(Color.WHITE);
        JLabel titulo = new JLabel("Selección de proyectos con generación aleatoria");
    ...
    private JPanel crearPanelControl() {
        ...
        btnGenerarAleatorio = crearBoton("🎲 Generar Variables Aleatorias", new Color(220, 20, 60), 280, 40);
    ...
    private void mostrarDialogoGeneracionAleatoria() {
        ...
        JLabel lblInfo = new JLabel("<html><div style='text-align: center;'>" +
            ...
            "• <b>Presupuesto:</b> Entre " + FMT_MONEY.format(Config.PRESUPUESTO_MIN) +
            " y " + FMT_MONEY.format(Config.PRESUPUESTO_MAX) + "<br>" +
            "• <b>Inversión de cada proyecto:</b> Entre " + FMT_MONEY.format(Config.INVERSION_MIN) +
        ...
        panelOpciones.setBorder(BorderFactory.createTitledBorder("Opciones de Generación"));
    ...
    private void generarVariablesAleatorias(boolean generarPresupuesto,
        ...
        if (generarPresupuesto) {
            ...
            // Redondear a múltiplos de 10000
